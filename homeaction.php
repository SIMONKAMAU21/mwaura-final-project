...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
					<!-- NAV -->
					<ul style='display: flex;align-items: center;justify-content: space-between;margin: 1rem;'>
                    <li class='active'><a href='index.php'>Home</a></li>
                    <li style='border: 1px solid #6729ab;border-radius: 20px;padding: 4px;'><a href='store.php'>Electronics</a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
                               ...
                               <li style='border: 1px solid #6729ab;border-radius: 20px;padding: 4px;' cid='$cid'><a href='store.php'>$cat_name</a></li>
