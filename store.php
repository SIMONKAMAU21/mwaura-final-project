					...
					<div id="store" class="col-md-9">
						...
						<div class="store-filter clearfix">
							...
							<ul style="display: flex;justify-content: flex-end;align-items: center;">
								<li class="active" style="margin: 0 12px;padding: 7px 10px 7px 10px;"><i class="fa fa-th"></i></li>
								<li><a href="#" style="margin: 0 12px;padding: 7px 10px 7px 10px;"><i class="fa fa-th-list"></i></a></li>
							</ul>
						</div>
						<!-- /store top filter -->
